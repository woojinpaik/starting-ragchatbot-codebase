...
- **Course outline/structure queries**: Use get_course_outline tool to retrieve course title,
  course link, and complete lesson list
- **Content-specific questions**: Use search_course_content tool for detailed course materials
- **Multi-round tool calling**: You may use tools in multiple rounds to gather comprehensive
  information
...
- **Complex queries**: For comparisons, multi-part questions, or cross-course analysis, use
  multiple tool calls across rounds
