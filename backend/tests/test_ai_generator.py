...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_generate_response_with_tool_use(self):
        ...
        mock_final_response.content = [Mock(text="Based on search results: Python is a programming language")]
...
class TestAIGeneratorToolIntegration(unittest.TestCase):
    ...
    def test_realistic_search_query_flow(self):
        ...
        mock_tool_content.type = "tool_use"
        mock_tool_content.name = "search_course_content"
        mock_tool_content.input = {"query": "variables in python", "course_name": "Python Basics"}
        mock_tool_content.id = "tool_use_123"
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="Variables in Python are used to store data. They are created when you assign a value to them.")]
    ...
    def test_realistic_outline_query_flow(self):
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="The Python Basics course covers fundamental programming concepts with 5 lessons including variables, functions, and control structures.")]
...
class TestAIGeneratorMultiRound(unittest.TestCase):
    ...
    def test_two_round_tool_calling_success(self):
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="Based on the course outline and content search, lesson 4 covers advanced concepts.")]
    ...
    def test_single_round_with_no_follow_up_needed(self):
        ...
        mock_response_2 = Mock()
        mock_response_2.content = [Mock(text="Python is a programming language used for web development, data science, and automation.")]
        mock_response_2.stop_reason = "end_turn"
        
        self.mock_client.messages.create.side_effect = [mock_response_1, mock_response_2]
    ...
    def test_max_rounds_termination(self):
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="Based on available information, here's the comparison.")]
        mock_final_response.stop_reason = "end_turn"
    ...
    def test_tool_error_in_first_round(self):
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="I apologize, but I encountered an error while searching. Let me provide a general answer.")]
        mock_final_response.stop_reason = "end_turn"
        
        self.mock_client.messages.create.side_effect = [mock_response_1, mock_final_response]
...
class TestAIGeneratorComparisonQueries(unittest.TestCase):
    ...
    def test_comparison_query_across_courses(self):
        ...
        mock_tool_content_1.type = "tool_use"
        mock_tool_content_1.name = "search_course_content"
        mock_tool_content_1.input = {"query": "machine learning", "course_name": "AI Fundamentals"}
        mock_tool_content_1.id = "tool_use_1"
        ...
        mock_tool_content_2.type = "tool_use"
        mock_tool_content_2.name = "search_course_content"
        mock_tool_content_2.input = {"query": "machine learning", "course_name": "Data Science"}
        mock_tool_content_2.id = "tool_use_2"
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="AI Fundamentals focuses on theoretical ML concepts, while Data Science emphasizes practical implementation.")]
        mock_final_response.stop_reason = "end_turn"
    ...
    def test_multi_part_question_requiring_outline_then_content(self):
        ...
        mock_tool_content_2.type = "tool_use"
        mock_tool_content_2.name = "search_course_content"
        mock_tool_content_2.input = {"query": "lesson 3 frameworks", "course_name": "Web Development"}
        mock_tool_content_2.id = "tool_use_2"
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="The Web Development course has 5 lessons. Lesson 3 focuses on frameworks like React and Vue.")]
        mock_final_response.stop_reason = "end_turn"
        ...
        mock_tool_manager.execute_tool.assert_any_call("get_course_outline", course_name="Web Development")
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", 
    ...
    def test_cross_lesson_analysis_query(self):
        ...
        mock_tool_content_1.type = "tool_use"
        mock_tool_content_1.name = "search_course_content"
        mock_tool_content_1.input = {"query": "lesson 2 variables", "course_name": "Programming Basics"}
        mock_tool_content_1.id = "tool_use_1"
        ...
        mock_tool_content_2.type = "tool_use"
        mock_tool_content_2.name = "search_course_content"
        mock_tool_content_2.input = {"query": "lesson 4 functions", "course_name": "Programming Basics"}
        mock_tool_content_2.id = "tool_use_2"
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="Variables from lesson 2 are used as parameters and return values in functions covered in lesson 4.")]
        mock_final_response.stop_reason = "end_turn"
...
class TestAIGeneratorTerminationAndErrorHandling(unittest.TestCase):
    ...
    def test_early_termination_no_tools_needed(self):
        ...
        mock_response = Mock()
        mock_response.content = [Mock(text="This is a general knowledge answer that doesn't require tools.")]
        mock_response.stop_reason = "end_turn"
    ...
    def test_termination_after_tool_execution_failure(self):
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="I apologize, but I encountered an error accessing the course materials.")]
        mock_final_response.stop_reason = "end_turn"
    ...
    def test_termination_at_second_round_limit(self):
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="Based on available information from searches, here's my answer.")]
        mock_final_response.stop_reason = "end_turn"
    ...
    def test_empty_tool_results_handling(self):
        ...
        mock_response_2 = Mock()
        mock_response_2.content = [Mock(text="I couldn't find any information about that topic in the course materials.")]
        mock_response_2.stop_reason = "end_turn"
